...
(function () {
    ...
    const MAPS = {
        ...
        A: { w: 1672, h: 941, def: 'day', pins: [
            ...
            { id: 'A_Solaris_Apex', x: 0.51, y: 0.29 },
            { id: 'A_Commerce_District', x: 0.372, y: 0.71 },
        ] },
        B: { w: 1672, h: 941, def: 'night', pins: [
            { id: 'B_LUXA_DOME', x: 0.296, y: 0.372 },
            { id: 'B_NOVA_Mall', x: 0.64, y: 0.352 },
            { id: 'B_Decibel_Ruins', x: 0.164, y: 0.716 },
            { id: 'B_Graffiti_Buildings', x: 0.435, y: 0.652 },
            { id: 'B_B_Street_24', x: 0.782, y: 0.69 },
            { id: 'B_Night_Market', x: 0.552, y: 0.564 },
            { id: 'B_Nocturne_Arena', x: 0.855, y: 0.43 },
            { id: 'B_Nocturne_Police', x: 0.148, y: 0.462 },
            { id: 'B_Residential_Zone', x: 0.594, y: 0.176 },
        ] },
        C: { w: 1672, h: 941, def: 'day', pins: [
            { id: 'C_Civic_Hall', x: 0.256, y: 0.33 },
            { id: 'C_Horizon_Medical', x: 0.744, y: 0.318 },
            { id: 'C_Central_Library', x: 0.508, y: 0.318 },
            { id: 'C_Light_Square', x: 0.5, y: 0.555 },
            { id: 'C_Daily_Market', x: 0.276, y: 0.74 },
            { id: 'C_Council_Hall', x: 0.2, y: 0.53 },
            { id: 'C_Education_District', x: 0.8, y: 0.62 },
            { id: 'C_Residential_Zone', x: 0.62, y: 0.79 },
        ] },
        D: { w: 1672, h: 941, def: 'dusk', pins: [
            { id: 'D_Vigil_Spire', x: 0.612, y: 0.298 },
            { id: 'D_Black_Obsidian', x: 0.336, y: 0.416 },
            { id: 'D_Sky_Dome_Port', x: 0.762, y: 0.148 },
            { id: 'D_Platinum_Promenade', x: 0.476, y: 0.568 },
            { id: 'D_Diamond_Marina', x: 0.61, y: 0.836 },
            { id: 'D_Noble_Social_Club', x: 0.79, y: 0.5 },
            { id: 'D_Ivory_High_School', x: 0.196, y: 0.63 },
            { id: 'D_Manor_District', x: 0.29, y: 0.222 },
        ] },
        E: { w: 1672, h: 941, def: 'night', pins: [
            { id: 'E_Wreckspire', x: 0.264, y: 0.196 },
            { id: 'E_Crimson_Cellar', x: 0.191, y: 0.761 },
            { id: 'E_Shadow_Furnace', x: 0.454, y: 0.746 },
            { id: 'E_Glitch_Dome', x: 0.497, y: 0.204 },
            { id: 'E_Null_Sanctuary', x: 0.751, y: 0.248 },
            { id: 'E_Pulse_Street', x: 0.445, y: 0.523 },
            { id: 'E_Silent_Haven', x: 0.199, y: 0.468 },
            { id: 'E_Tin_City', x: 0.737, y: 0.462 },
            { id: 'E_Mod_Workshop', x: 0.586, y: 0.671 },
            { id: 'E_Tin_Garage', x: 0.844, y: 0.712 },
        ] },
        F: { w: 1672, h: 941, def: 'morning', pins: [
            { id: 'F_Container_Dock', x: 0.53, y: 0.578 },
            { id: 'F_Aether_Towers', x: 0.27, y: 0.324 },
            { id: 'F_Harbor_Loft', x: 0.744, y: 0.268 },
            { id: 'F_Dock_Canteen', x: 0.85, y: 0.66 },
        ] },
        G: { w: 1672, h: 941, def: 'night', pins: [
            { id: 'G_Silver_Tier', x: 0.352, y: 0.622 },
            { id: 'G_Gold_Tier', x: 0.352, y: 0.49 },
            { id: 'G_Diamond_VIP', x: 0.352, y: 0.372 },
            { id: 'G_Sky_Palace_Hotel', x: 0.648, y: 0.28 },
            { id: 'G_Entertainment_Hub', x: 0.666, y: 0.61 },
            { id: 'G_Underground_Ring', x: 0.352, y: 0.8 },
        ] },
    };
