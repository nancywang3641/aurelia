...
- **好感度＝對主角的「情感親密／信任」程度，不是性慾或肉體關係**：性事／親密接觸／NSFW 本身不自動讓好感度暴漲——只有劇情明寫情感層面的推進（交心、被打動、確立關係、長期陪伴）才算；純肉慾／逢場作戲／被誘惑／一夜情對好感度的影響要很小、甚至為 0。好感度每輪通常只小幅變動（個位數），唯有重大情感事件才給較大增減。對「身體/慾望」另有欄位的世界，性事的強度寫進那種欄位、別灌進好感度。
