...
"2girls, a pale-skinned girl on the left reaches toward a tanned girl on the right, [(adult:1.5), left_side, pale_skin, gentle_vibe, long_silver_hair, soft_bangs, white_dress, reaching_out, worried_expression] AND [(adult:1.5), right_side, tanned_skin, calm_vibe, short_dark_hair, no_bangs, casual_jacket, stepping_back, neutral_expression], tense_atmosphere, dramatic_moment, rainy_street, night, from_side, medium_shot, shallow_depth_of_field"`,
    ...
    function loadClaudeRoomConfig() {
        ...
        let config = {
            ...
            endpoints: {
                pc:  { name: '🏠 本機 PC',  url: 'https://bridge.example.com/v1/chat/completions', token: '', apiKey: '' },
                vps: { name: '☁️ VPS Cloud', url: 'https://bridge-vps.example.com/v1/chat/completions',   token: '', apiKey: '' },
            },
                        ...
                        <div class="set-group">
                            ...
                            <div style="background:rgba(69,34,22,0.4); border:1px solid rgba(251,223,162,0.2); border-radius:6px; padding:10px; margin-bottom:8px;">
                                ...
                                <div style="margin-top:8px;">
                                    <input class="set-input" id="claude-ep-pc-url" placeholder="https://bridge.example.com/v1/chat/completions" value="${claudeRoomConfig.endpoints?.pc?.url || ''}">
                            ...
                            <div style="background:rgba(69,34,22,0.4); border:1px solid rgba(251,223,162,0.2); border-radius:6px; padding:10px;">
                                ...
                                <div style="margin-top:8px;">
                                    <input class="set-input" id="claude-ep-vps-url" placeholder="https://bridge-vps.example.com/v1/chat/completions" value="${claudeRoomConfig.endpoints?.vps?.url || ''}">
                                </div>
                                <div style="margin-top:6px;">
