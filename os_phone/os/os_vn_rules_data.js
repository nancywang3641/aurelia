...
[角色名] [撤回] 消息內容
[系統] 系統提示訊息
[系統] 你已刪除好友「角色名」   ←主角刪掉這個人的微信時寫；封鎖寫 [系統] 你已將「角色名」加入黑名單；之後又加回來寫 [系統] 你已添加了角色名
[系統] 角色名開啟了朋友驗證，你還不是他（她）朋友   ←反過來，某個角色把主角刪了或拉黑時寫；主角之後在那間聊天室送出的訊息對方都收不到（程式會自己補「消息已發出，但被對方拒收了」），直到那個角色重新加主角好友（寫 [系統] 「角色名」请求添加你为朋友）或主角被加回來
