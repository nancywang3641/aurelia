...
（劇情裡有人掃碼付錢——主角買東西、付車資、結帳，或別人掃主角的碼把錢付給他——不要寫進聊天室，而是在正文裡把那個付款畫面照它自己的格式整塊寫出來：開頭跟結尾那兩行標籤都要寫，少了外面那層它不會變成畫面。第一行寫的是「誰收這筆錢」——錢進主角口袋就在那一格原樣寫 {{user}} 這幾個字（不要寫他的名字），錢是主角付出去的就寫店家名或對方的名字。金額照實填，錢會照畫面上的數字真的進出主角的錢包；只用一句話說他付了、他收了，是不算的。）
