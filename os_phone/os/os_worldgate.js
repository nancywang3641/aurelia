...
(function () {
    ...
    const _PANEL_RULES =
        ...
        '【按鈕的設計思維】從下面四個角度挑「一個」當這個世界所有按鈕的共同語言,不要四種混用,也不要每次都挑同一個:\n' +
        '　A 擬物道具:把按鈕做成這個世界裡真的存在的某件物品(有它的轉軸、卡榫、紋路、傾斜角度)。' +
        '滑鼠移上去時是那件物品的狀態改變——蓋子掀開、扣環鬆開、齒輪轉一格。\n' +
        '　B 機能票券:切角邊框(clip-path)、打孔票根、警示斜紋、高對比色塊,配上編號、刻度、細小標記。' +
        '滑鼠移上去時是掃描線滑過、色塊反轉、切角平移。\n' +
        '　C 字體穿插:粗體主字與傾斜的手寫感字體互相疊壓,底下墊徽章或印章式的幾何。' +
        '滑鼠移上去時字浮起、陰影擴散、輕微震動。\n' +
        '　D 氛圍材質:光暈、流動、發光符號、故障干擾、撕裂邊緣,靠漸層與陰影做出材質感。' +
        '滑鼠移上去時光暈擴散、符號點亮。\n' +
