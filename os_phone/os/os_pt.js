...
(function () {
    ...
    function _injectStyle() {
        ...
        s.textContent = [
            ...
            '.os-pt-shop-head .x:hover{opacity:1;background:rgba(255,255,255,.1);}',
            '.os-pt-shop-sub{font-size:12px;color:#9d94b5;margin-bottom:16px;}',
            '.os-pt-wallet{display:flex;align-items:center;gap:8px;justify-content:center;margin:8px 0 18px;',
            'padding:12px;border-radius:14px;background:rgba(255,226,138,.08);border:1px solid rgba(255,226,138,.25);}',
            '.os-pt-wallet i{color:#ffe28a;font-size:20px;}',
            '.os-pt-wallet .n{font-size:26px;font-weight:800;color:#ffe28a;font-variant-numeric:tabular-nums;}',
            '.os-pt-wallet .u{font-size:13px;color:#c9bfe0;align-self:flex-end;margin-bottom:3px;}',
            '.os-pt-item{display:flex;align-items:center;gap:14px;padding:14px;border-radius:16px;',
            'background:rgba(255,255,255,.04);border:1px solid rgba(180,150,255,.2);margin-bottom:12px;}',
            '.os-pt-item .ic{width:46px;height:46px;border-radius:12px;display:flex;align-items:center;justify-content:center;',
            'background:rgba(180,150,255,.15);color:#c9a6ff;font-size:22px;flex:0 0 auto;}',
            '.os-pt-item .body{flex:1;min-width:0;}',
            '.os-pt-item .body .n{font-weight:700;font-size:15px;}',
            '.os-pt-item .body .d{font-size:12px;color:#9d94b5;margin-top:2px;}',
            '.os-pt-buy{flex:0 0 auto;border:none;cursor:pointer;border-radius:12px;padding:9px 16px;font-size:14px;font-weight:700;',
            'font-family:inherit;background:linear-gradient(135deg,#a877ff,#7b5bff);color:#fff;transition:filter .2s,opacity .2s;}',
            '.os-pt-buy:hover{filter:brightness(1.12);}',
            '.os-pt-buy:disabled{cursor:default;opacity:.5;filter:grayscale(.4);}',
            '.os-pt-buy.owned{background:rgba(255,255,255,.1);color:#b9f6c8;}',
            '.os-pt-shop-msg{min-height:18px;text-align:center;font-size:12.5px;margin-top:6px;color:#ff9db0;}',
            '.os-pt-shop-msg.ok{color:#b9f6c8;}',
        ].join('');
