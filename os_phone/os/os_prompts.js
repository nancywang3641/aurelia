...
- 主角開導航去某地時，包在 <nav to="目的地" from="出發地" mode="步行／計程車／空軌"> 內：每一步一行 [Step: 怎麼走]（2～5 步，用這個世界裡的路名地標），到了寫 [Arrive]；路上的反應可用 [Nar|…]。[Route: 幾分鐘|幾公里] 可省，程式會算。</nav> 收尾。地圖是程式畫的，不必描述地圖長相。
