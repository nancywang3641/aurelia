...
### 對話與旁白
[Char|角色名|表情|「台詞內容」|Stay]  ← 角色台詞。表情: normal/happy/sad/angry/surprised/shy等
[Nar|旁白文字]                        ← 第三人稱旁白，描述場景或動作
[Inner|角色名|「內心獨白」]           ← 角色的內心獨白（斜體感）
[Exit|角色名]                         ← 僅「角色沒有台詞就離開現場」時輸出此行移除其立繪；有告別台詞一律改用末欄 Leave，不再另發此行

⚠️ [Char] 末欄＝站位狀態，固定二選一、每行必帶不可省略：
- Stay：說完這句後仍在場
- Leave：說完這句後離場（立繪自動移除）
