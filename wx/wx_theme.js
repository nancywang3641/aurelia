...
// [檔案 1] wx_theme.js
// 模塊：外觀樣式 (View/Style)
// 職責：定義所有 CSS，包含動畫、手機外殼、氣泡配色。
// ----------------------------------------------------------------

(function() {
    window.WX_THEME = {
        // 版本號 (用於緩存管理)
        version: 'v71.8-modular',
        ...
        css: `
            ...
            .wx-grid-icon { width: 55px; height: 55px; background: #fff; border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 26px; border: 1px solid #e0e0e0; }
